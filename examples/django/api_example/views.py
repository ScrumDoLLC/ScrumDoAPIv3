...
request_token_url = "%s/api/v3/oauth/request_token/" % settings.SCRUMDO_HOSTNAME
access_token_url = "%s/api/v3/oauth/access_token/" % settings.SCRUMDO_HOSTNAME
authorize_url = "%s/api/v3/oauth/authorize/" % settings.SCRUMDO_HOSTNAME
...
def unauthenticated_home(request):
    ...
    logger.info("Requesting %s" % request_token_url)
